...
struct GoalSettingsView: View {
    ...
    init(stepsGoal: Binding<Int>, caloriesGoal: Binding<Int>, distanceGoal: Binding<Int>) {
        self._stepsGoal = stepsGoal
        self._caloriesGoal = caloriesGoal
        self._distanceGoal = distanceGoal
        self._localStepsGoal = State(initialValue: Double(stepsGoal.wrappedValue))
        self._localCaloriesGoal = State(initialValue: Double(caloriesGoal.wrappedValue))
        self._localDistanceGoal = State(initialValue: Double(distanceGoal.wrappedValue) / 1000.0)
    }
